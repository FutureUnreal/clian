...
export class SubagentManager {
  ...
  private updateSubagentLabel(
    ...
    if (description) {
      ...
      const labelEl = wrapperEl.querySelector('.clian-subagent-label') as HTMLElement | null;
      if (labelEl) {
    ...
    if (prompt) {
      info.prompt = prompt;
      const promptEl = wrapperEl.querySelector('.clian-subagent-prompt-text') as HTMLElement | null;
      if (promptEl) {
