...
export type TranslationKey =
  ...
  | 'settings.titleEngine.name'
  | 'settings.titleEngine.desc'
  | 'settings.titleEngine.auto'
  | 'settings.titleEngine.claude'
  ...
  // Settings - Slash Commands / Skills
  ...
  | 'settings.extraClaudeModels.name'
  | 'settings.extraClaudeModels.desc'
  ...
  // Settings - Engines (Codex / Gemini)
  | 'settings.codex.name'
  | 'settings.codex.desc'
  | 'settings.codex.command.name'
  | 'settings.codex.command.desc'
  | 'settings.codex.model.name'
  | 'settings.codex.model.desc'
  | 'settings.codex.thinking.name'
  | 'settings.codex.thinking.desc'
  | 'settings.claude.name'
  | 'settings.claude.desc'
  | 'settings.claude.model.name'
  | 'settings.claude.model.desc'
  | 'settings.claude.thinking.name'
  | 'settings.claude.thinking.desc'
  | 'settings.gemini.name'
  | 'settings.gemini.desc'
  | 'settings.gemini.command.name'
  | 'settings.gemini.command.desc'
  | 'settings.gemini.model.name'
  | 'settings.gemini.model.desc'
  | 'settings.gemini.thinking.name'
  | 'settings.gemini.thinking.desc'
