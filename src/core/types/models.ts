...
export const DEFAULT_CLAUDE_MODELS: { value: ClaudeModel; label: string; description: string }[] = [
  // Concrete model IDs (Claude Code)
  { value: 'claude-haiku-4-5', label: 'Haiku 4.5', description: 'Model ID: claude-haiku-4-5' },
  { value: 'claude-sonnet-4-5', label: 'Sonnet 4.5', description: 'Model ID: claude-sonnet-4-5' },
  { value: 'claude-opus-4-5', label: 'Opus 4.5', description: 'Model ID: claude-opus-4-5' },
  { value: 'claude-sonnet-4-6', label: 'Sonnet 4.6', description: 'Model ID: claude-sonnet-4-6' },
  { value: 'claude-opus-4-6', label: 'Opus 4.6', description: 'Model ID: claude-opus-4-6' },
];
...
export const DEFAULT_THINKING_BUDGET: Record<string, ThinkingBudget> = {
  ...
  'claude-opus-4-5-20250929': 'medium',
