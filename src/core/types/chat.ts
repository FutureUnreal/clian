...
/** Which agent backend produced / owns this conversation. */
export type ChatFlavor = 'claude' | 'codex' | 'gemini';

/** View type identifier for Obsidian. */
export const VIEW_TYPE_CLIAN = 'clian-view';

export const SUPPORTED_VIEW_TYPES = [VIEW_TYPE_CLIAN] as const;
export type ClianViewType = typeof SUPPORTED_VIEW_TYPES[number];
...
export interface SessionMetadata {
   ...
   * Stored here because SDK session files don't preserve this Clian-specific data.
   */
  subagentData?: Record<string, SubagentInfo>;
  /** Assistant UUID for resumeSessionAt after rewind. */
  resumeSessionAt?: string;
