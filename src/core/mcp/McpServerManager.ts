...
export class McpServerManager {
  ...
  private collectDisallowedTools(filter?: (server: ClianMcpServer) => boolean): string[] {
  ...
  getContextSavingServers(): ClianMcpServer[] {
