...
import type { ClianMcpServer } from '../types';
...
export async function testMcpServer(server: ClianMcpServer): Promise<McpTestResult> {
  ...
  const client = new Client({ name: 'clian-tester', version: '1.0.0' });
