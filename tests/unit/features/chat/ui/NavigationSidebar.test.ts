...
describe('NavigationSidebar', () => {
  ...
  describe('initialization', () => {
    it('should create container with correct class', () => {
      ...
      const container = parentEl.querySelector('.clian-nav-sidebar');
  ...
  describe('previous/next message navigation', () => {
    function addUserMessage(el: MockElement, offset: number): MockElement {
      const msg = el.createDiv({ cls: 'clian-message clian-message-user' });
      msg.offsetTop = offset;
      return msg;
    }

    function addAssistantMessage(el: MockElement, offset: number): MockElement {
      const msg = el.createDiv({ cls: 'clian-message clian-message-assistant' });
      msg.offsetTop = offset;
      return msg;
    }
    ...
    function getButtons(parent: MockElement) {
      const container = parent.querySelector('.clian-nav-sidebar')!;
      return {
  ...
  describe('destroy', () => {
    it('should remove container from DOM', () => {
      ...
      expect(parentEl.querySelector('.clian-nav-sidebar')).not.toBeNull();

      sidebar.destroy();

      expect(parentEl.querySelector('.clian-nav-sidebar')).toBeNull();
    });
  });
});
