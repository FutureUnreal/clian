...
describe('Async Subagent Renderer', () => {
  ...
  it('shows prompt in content and keeps label visible while running', () => {
    ...
    const contentText = getTextByClass(state.contentEl as any, 'clian-subagent-prompt-text')[0];
  ...
  it('finalizes to completed and reveals description', () => {
    ...
    const contentText = getTextByClass(state.contentEl as any, 'clian-subagent-result-output')[0];
  ...
  describe('renderStoredAsyncSubagent', () => {
    it('should return wrapper element', () => {
      ...
      expect((wrapperEl as any).hasClass('clian-subagent-list')).toBe(true);
    });
    ...
    it('shows tool-use count in async header', () => {
      ...
      const wrapperEl = renderStoredAsyncSubagent(parentEl as any, subagent);
      const countText = getTextByClass(wrapperEl as any, 'clian-subagent-count')[0];
    ...
    it('renders error status correctly', () => {
      ...
      const contentText = getTextByClass(wrapperEl as any, 'clian-subagent-result-output')[0];
    ...
    it('renders running status with prompt', () => {
      ...
      const contentText = getTextByClass(wrapperEl as any, 'clian-subagent-prompt-text')[0];
...
describe('finalizeSubagentBlock', () => {
  ...
  it('keeps tool history and shows result section text', () => {
    ...
    const doneText = getTextByClass(state.contentEl as any, 'clian-subagent-result-output')[0];
  ...
  it('shows ERROR text when isError is true', () => {
    ...
    const errorText = getTextByClass(state.contentEl as any, 'clian-subagent-result-output')[0];
...
describe('renderStoredSubagent status variants', () => {
  ...
  it('renders completed subagent with done class and check icon', () => {
    ...
    expect(setIcon).toHaveBeenCalledWith(expect.anything(), 'check');
    const doneText = getTextByClass(wrapperEl as any, 'clian-subagent-result-output')[0];
    expect(doneText).toBe('DONE');
  });
  ...
  it('renders error subagent with error class and x icon', () => {
    ...
    expect((wrapperEl as any).hasClass('error')).toBe(true);
    expect(setIcon).toHaveBeenCalledWith(expect.anything(), 'x');
    const errorText = getTextByClass(wrapperEl as any, 'clian-subagent-result-output')[0];
  ...
  it('renders running subagent tool call with expanded-style result', () => {
    ...
    const resultTexts = getTextByClass(contentEl, 'clian-tool-line');
  ...
  it('shows correct tool count in badge', () => {
    ...
    const countTexts = getTextByClass(wrapperEl as any, 'clian-subagent-count');
  ...
  it('truncates long descriptions', () => {
    ...
    const labelTexts = getTextByClass(wrapperEl as any, 'clian-subagent-label');
