...
describe('TitleGenerationService', () => {
  ...
  describe('generateTitle', () => {
    ...
    it('should use no tools for title generation', async () => {
      ...
      const callback = jest.fn();
      await service.generateTitle('conv-123', 'test', 'claude', callback);
    ...
    it('should truncate long user messages', async () => {
      ...
      const callback = jest.fn();
      await service.generateTitle('conv-123', longMessage, 'claude', callback);
  ...
  describe('concurrent generation', () => {
    it('should support multiple concurrent generations', async () => {
      ...
      const promise1 = service.generateTitle('conv-1', 'msg1', 'claude', callback1);
      const promise2 = service.generateTitle('conv-2', 'msg2', 'claude', callback2);
    ...
    it('should cancel previous generation for same conversation', async () => {
      ...
      const promise2 = service.generateTitle('conv-1', 'msg2', 'claude', callback2);
  ...
  describe('cancel', () => {
    it('should cancel all active generations', async () => {
      ...
      const promise = service.generateTitle('conv-1', 'msg', 'claude', callback);
      service.cancel();
  ...
  describe('safeCallback', () => {
    it('should catch errors thrown by callback', async () => {
      ...
      // Should not throw
      await expect(
        service.generateTitle('conv-123', 'test', 'claude', throwingCallback)
