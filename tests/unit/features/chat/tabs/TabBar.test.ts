...
describe('TabBar', () => {
  describe('constructor', () => {
    it('should add tab badges class to container', () => {
      ...
      expect(containerEl._classList.has('clian-tab-badges')).toBe(true);
    });
  });
  ...
  describe('badge state classes', () => {
    it('should apply idle class for inactive tab', () => {
      ...
      expect(containerEl._children[0]._classList.has('clian-tab-badge-idle')).toBe(true);
    });
    ...
    it('should apply active class for active tab', () => {
      ...
      expect(containerEl._children[0]._classList.has('clian-tab-badge-active')).toBe(true);
    });
    ...
    it('should apply streaming class for streaming tab', () => {
      ...
      expect(containerEl._children[0]._classList.has('clian-tab-badge-streaming')).toBe(true);
    });
    ...
    it('should apply attention class for tab needing attention', () => {
      ...
      expect(containerEl._children[0]._classList.has('clian-tab-badge-attention')).toBe(true);
    });
    ...
    it('should prioritize active over attention', () => {
      ...
      expect(containerEl._children[0]._classList.has('clian-tab-badge-active')).toBe(true);
      expect(containerEl._children[0]._classList.has('clian-tab-badge-attention')).toBe(false);
    });
    ...
    it('should prioritize attention over streaming', () => {
      ...
      expect(containerEl._children[0]._classList.has('clian-tab-badge-attention')).toBe(true);
      expect(containerEl._children[0]._classList.has('clian-tab-badge-streaming')).toBe(false);
    });
  ...
  describe('destroy', () => {
    ...
    it('should remove tab badges class from container', () => {
      ...
      expect(containerEl._classList.has('clian-tab-badges')).toBe(false);
    });
  });
});
