...
describe('types.ts', () => {
  describe('VIEW_TYPE_CLIAN', () => {
    it('should be defined as the correct view type', () => {
      expect(VIEW_TYPE_CLIAN).toBe('clian-view');
    });
  });
  ...
  describe('DEFAULT_SETTINGS', () => {
    ...
    it('should have lastClaudeModel set to a concrete default by default', () => {
  ...
  describe('ClianSettings type', () => {
    it('should be assignable with valid settings', () => {
      const settings: ClianSettings = {
        userName: '',
