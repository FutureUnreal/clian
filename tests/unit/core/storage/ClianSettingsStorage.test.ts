...
} from '@/core/storage/ClianSettingsStorage';
...
describe('ClianSettingsStorage', () => {
  let storage: ClianSettingsStorage;
  ...
  beforeEach(() => {
    ...
    storage = new ClianSettingsStorage(mockAdapter);
  });
  ...
  describe('exists', () => {
    it('should return true when file exists', async () => {
      ...
      expect(mockAdapter.exists).toHaveBeenCalledWith(CLIAN_SETTINGS_PATH);
    });
