...
Run tests for $ARGUMENTS.`;
  ...
  describe('loadAll', () => {
    it('loads all commands from vault', async () => {
      mockAdapter.listFilesRecursive.mockResolvedValue([
        '.clian/commands/review-code.md',
        '.clian/commands/test/coverage.md',
        '.clian/commands/deploy.sh',
      ]);
      mockAdapter.read
    ...
    it('continues loading if one file fails', async () => {
      mockAdapter.listFilesRecursive.mockResolvedValue([
        '.clian/commands/good.md',
        '.clian/commands/bad.md',
        '.clian/commands/good2.md',
      ]);
      mockAdapter.read
        .mockResolvedValueOnce(validMarkdown)
    ...
    it('handles deeply nested commands', async () => {
      mockAdapter.listFilesRecursive.mockResolvedValue([
        '.clian/commands/level1/level2/level3/deep.md',
      ]);
      mockAdapter.read.mockResolvedValue(validMarkdown);
  ...
  describe('loading single files (tested through loadAll)', () => {
    it('loads a command from file path', async () => {
      mockAdapter.listFilesRecursive.mockResolvedValue(['.clian/commands/review-code.md']);
      mockAdapter.read.mockResolvedValue(validMarkdown);
    ...
    it('loads nested command correctly', async () => {
      mockAdapter.listFilesRecursive.mockResolvedValue(['.clian/commands/test/coverage.md']);
...
Just a simple prompt with $ARGUMENTS.`;
      ...
      mockAdapter.listFilesRecursive.mockResolvedValue(['.clian/commands/simple.md']);
...
Do the thing`;
      ...
      mockAdapter.listFilesRecursive.mockResolvedValue(['.clian/commands/skill-cmd.md']);
  ...
  describe('save', () => {
    it('saves command to correct file path', async () => {
      ...
      const expectedPath = '.clian/commands/review-code.md';
    ...
    it('saves nested command to correct nested path', async () => {
      ...
      const expectedPath = '.clian/commands/test/coverage.md';
    ...
    it('sanitizes command name when generating path', async () => {
      ...
      expect(mockAdapter.write).toHaveBeenCalledWith(
        '.clian/commands/test-command---.md',
        expect.anything()
      );
    });
    ...
    it('preserves slashes for deeply nested command path', async () => {
      ...
      expect(mockAdapter.write).toHaveBeenCalledWith(
        '.clian/commands/level1/level2/level3.md',
        expect.anything()
      );
    });
    ...
    it('round-trips skill fields through save and load', async () => {
      ...
      mockAdapter.listFilesRecursive.mockResolvedValue(['.clian/commands/roundtrip.md']);
  ...
  describe('delete', () => {
    it('deletes command by ID', async () => {
      ...
      expect(mockAdapter.delete).toHaveBeenCalledWith('.clian/commands/review-code.md');
    });
    ...
    it('deletes nested command by ID', async () => {
      ...
      expect(mockAdapter.delete).toHaveBeenCalledWith('.clian/commands/test/coverage.md');
    });
    ...
    it('handles command with dashes in name', async () => {
      ...
      expect(mockAdapter.delete).toHaveBeenCalledWith('.clian/commands/test-command.md');
    });
  ...
  describe('filePathToId (private method tested through loadAll)', () => {
    it('encodes simple path correctly', async () => {
      mockAdapter.listFilesRecursive.mockResolvedValue(['.clian/commands/test.md']);
      mockAdapter.read.mockResolvedValue(validMarkdown);
    ...
    it('encodes path with slashes correctly', async () => {
      mockAdapter.listFilesRecursive.mockResolvedValue(['.clian/commands/a/b.md']);
      mockAdapter.read.mockResolvedValue(validMarkdown);
    ...
    it('encodes path with both slashes and dashes correctly', async () => {
      mockAdapter.listFilesRecursive.mockResolvedValue(['.clian/commands/a/b-c.md']);
      mockAdapter.read.mockResolvedValue(validMarkdown);
