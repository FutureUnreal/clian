...
function clickButton(root: any, text: string): void {
  const buttons = findAllByClass(root, 'clian-instruction-btn');
...
describe('InstructionModal', () => {
  describe('onOpen', () => {
    it('renders the raw instruction text', () => {
      ...
      const originalEl = findByClass(contentEl, 'clian-instruction-original');
    ...
    it('starts in loading state', () => {
      ...
      const loadingEl = findByClass(contentEl, 'clian-instruction-loading');
      expect(loadingEl).not.toBeNull();
      expect(loadingEl.style.display).not.toBe('none');

      const clarificationEl = findByClass(contentEl, 'clian-instruction-clarification-section');
      expect(clarificationEl.style.display).toBe('none');

      const confirmationEl = findByClass(contentEl, 'clian-instruction-confirmation-section');
    ...
    it('renders Cancel button in loading state', () => {
      ...
      const buttons = findAllByClass(contentEl, 'clian-instruction-btn');
  ...
  describe('showClarification', () => {
    ...
    it('displays the clarification text', () => {
      ...
      const clarificationTextEl = findByClass(contentEl, 'clian-instruction-clarification');
  ...
  describe('showConfirmation', () => {
    ...
    it('displays the refined instruction', () => {
      ...
      const refinedEl = findByClass(contentEl, 'clian-instruction-refined');
